...
/**
 * Dependencies element in a Maven POM file. It can occur in many locations in a POM file, but always having
...
public record DependenciesElement(Element backingElement) implements AnyPomElement {
    ...
    public ImmutableList<DependencyElement> dependencyElements() {
        return childElementStream(DependencyElement.class).collect(ImmutableList.toImmutableList());
    }
}
