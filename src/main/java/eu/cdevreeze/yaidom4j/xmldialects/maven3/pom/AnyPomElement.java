...
public interface AnyPomElement {
    ...
    ImmutableMap<QName, Function<Element, AnyPomElement>> constructorMap =
            ImmutableMap.<QName, Function<Element, AnyPomElement>>builder()
                    ...
                    .put(new QName(MAVEN_POM_NS, "organization"), OrganizationElement::new)
                    ...
                    .put(new QName(MAVEN_POM_NS, "build"), BuildElement::new)
                    .put(new QName(MAVEN_POM_NS, "reports"), ReportsElement::new)
