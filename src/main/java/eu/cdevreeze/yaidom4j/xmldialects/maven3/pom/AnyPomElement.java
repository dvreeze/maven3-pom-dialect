...
public interface AnyPomElement {
    ...
    ImmutableMap<QName, Function<Element, AnyPomElement>> constructorMap =
            ImmutableMap.<QName, Function<Element, AnyPomElement>>builder()
                    ...
                    .put(new QName(NS, "inceptionYear"), InceptionYearElement::new)
                    .put(new QName(NS, "organization"), OrganizationElement::new)
                    .put(new QName(NS, "licenses"), LicensesElement::new)
                    .put(new QName(NS, "license"), LicenseElement::new)
                    .put(new QName(NS, "developers"), DevelopersElement::new)
                    .put(new QName(NS, "developer"), DeveloperElement::new)
                    .put(new QName(NS, "contributors"), ContributorsElement::new)
                    .put(new QName(NS, "contributor"), ContributorElement::new)
                    .put(new QName(NS, "mailingLists"), MailingListsElement::new)
                    .put(new QName(NS, "mailingList"), MailingListElement::new)
                    .put(new QName(NS, "prerequisites"), PrerequisitesElement::new)
                    .put(new QName(NS, "modules"), ModulesElement::new)
                    .put(new QName(NS, "module"), ModuleElement::new)
                    .put(new QName(NS, "scm"), ScmElement::new)
                    .put(new QName(NS, "issueManagement"), IssueManagementElement::new)
                    .put(new QName(NS, "ciManagement"), CiManagementElement::new)
                    .put(new QName(NS, "distributionManagement"), DistributionManagementElement::new)
                    ...
                    .put(new QName(NS, "repositories"), RepositoriesElement::new)
                    .put(new QName(NS, "repository"), RepositoryElement::new)
                    .put(new QName(NS, "pluginRepositories"), PluginRepositoriesElement::new)
                    .put(new QName(NS, "pluginRepository"), PluginRepositoryElement::new)
                    .put(new QName(NS, "build"), BuildElement::new)
                    .put(new QName(NS, "reports"), ReportsElement::new)
